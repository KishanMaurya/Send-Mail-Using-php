	...
	<body>
						...
						<div class="card-body">
							<form action="#" method="post">
								...
								<div class="form-group">
									<input type="text" name="mail_to" class="form-control" placeholder="Enter Send to mail" required>
								</div>
								<label for="">Subject:</label>
								<div class="form-group">
									<input type="text" name="mail_sub" class="form-control" placeholder="Enter Send to mail" required>
								</div>
								<label for="">Massege:</label>
								<div class="form-group">
									<input type="text" name="mail_msg" class="form-control" placeholder="Enter Send to mail" required>
								</div>
		...
		<?php
		   if (isset($_POST['mail'])) {
			   ...
			   $mail ->IsHTML(true);
			   $mail ->Username = "fullstack49kishan@gmail.com";
			   $mail ->Password = "fullstack@49";
			   $mail ->SetFrom("fullstack49kishan@gmail.com");
			   ...
			   $mail ->Body ='
					...
					<body>
						<h3></h3>
						<p class="text-danger">thank you kishan for contact us.</p>
